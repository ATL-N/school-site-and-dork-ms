...
const ClassManagement = () => {
  ...
  const fetchAllClasses = async (searchQuery1 = "") => {
    try {
      // setIsLoading(true);
      setError(null);
  ...
  const handleSearchInputChange = (e) => {
    ...
    // fetchAllClasses(e.target.value);
  };
      ...
      <div className="pb-16 text-cyan-600">
        ...
        <div className="bg-white p-4 rounded shadow mb-6">
          ...
          <div className="overflow-x-auto tableWrap">
            <CustomTable
              data={extractEvaluationData(allClasses)}
        ...
        <div className="bg-white p-4 rounded shadow mb-6 text-cyan-500">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={classesData?.classes}>
              ...
              <XAxis dataKey="class_name" name="class name" />
              <YAxis />
              <Tooltip />
              <Legend />
              <Bar dataKey="unique_subjects" name={"subjects"} fill="#8884d8" />
            </BarChart>
          </ResponsiveContainer>
        </div>
        <div className="bg-white p-4 rounded shadow mb-6 text-cyan-500">
